...
const SubsidiariesSection = () => {
	return (
		<section className=" pb-20">
			...
			<div className=" mx-auto flex flex-wrap  items-stretch justify-center gap-x-6 gap-y-[75px]  "style={{marginTop:"100px"}}>
				{Object.keys(companiesData).map((companyId) => {
					let companyData = companiesData[companyId];
			...
			<h2 className="md:header3 body-medium-bold mb-20 w-full text-center text-navy-basic"style={{marginTop:"50px"}}>
				Our partners
			</h2>
			<div className=" mx-auto flex flex-wrap  items-stretch justify-center gap-x-6 gap-y-[75px]  ">
				{Object.keys(companiesData).map((companyId) => {
