    ...
    <section className="flex flex-col items-center gap-5 lg:flex-row lg:items-start lg:justify-between">
      ...
      <div className="space-y-4 text-center lg:w-1/2 lg:text-left">
        ...
        <p className="body-small-regular md:body-medium-regular">
          PTS is a leading Investment firm that provides clients and partners
          with strategic advice within several structural and operational
          domains. We leverage our Executive Partners’ extensive experience and
          network in the region to help our clients conduct business in Egypt,
          the MEA Region
        </p>
      </div>
    </section>
