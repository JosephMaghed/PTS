export const companiesData = {
    "pts-projects": {
        ...
        img: "/assets/pics/PTS-projects.png",
        category: "structure",
    },
    "pts-finance": {
        name: "PTS Finance LLC",
        logo: "/assets/logos/pts-finance.svg",
        description: `PTS Finance is the designed supply chain finance guide that establishes financial prosperity, creates sustainable economic gains, the hassle-free, smart experienced that allows  both buyers and sellers to to optimize cash flow at both ends of the supply chain and unlock trapped working capital.
		\nPTS Finance is the Cross Border Solution to offer businesses the most flexible financing options allowing your business to hold on to cash for longer while also ensuring your suppliers get paid on time. It’s an easy win-win for all parties. You can optimize working capital and give your suppliers access to critical cash flow to create more sustainability and profitability mitigating the risks.`,
        services: [
            "Financial prosperity planning: Comprehensive plans for sustainable economic gains. Strategies to foster growth and profitability while minimizing risks.",
            "Cross-border financing solutions: Efficient management of international transactions. Smooth cross-border payments and cash flow optimization.",
            "Working capital optimization: Unlock trapped working capital. Enhance cash flow and liquidity through effective management.",
            "Cash flow management services: Tools and insights for effective cash flow monitoring and management.",
            "Flexible financing options for businesses: Customized financing solutions to suit individual business needs.",
        ],
        img: "/assets/pics/PTS-finance.png",
        category: "structure",
    },
    ...
    "pts-systems": {
        ...
        services: [
            ...
            "Tailored Technological Implementations: Customized tech solutions for optimal performance.",
            "Disruptive Technology Integration: Staying ahead with cutting-edge technology integration.",
        ],

        img: "/assets/pics/PTS-Technology.jpg",
        category: "structure",
    },
    "pts-capital": {
        name: "PTS Capital LLC",
        logo: "/assets/logos/pts-capital.svg",
        description:
            "PTS Capital is an advisory firm built by partners who share common values and objectives. We facilitate access to capital for our clients and identify investment opportunities that match their strategic and financial targets.",
        services: [
            "Advanced Engineering Solutions: Next-gen products blending expertise and innovation to meet business objectives.",
            "Managed and Professional Services: Timely implementation and tailored systems with expert guidance.",
            "Tailored Technological Implementations: Customized tech solutions for optimal performance.",
        ...
        img: "/assets/pics/PTS-capital.jpg",
        category: "structure",
    },
    ...
    "Insta-deal": {
        ...
        services: [
            `Deals`,
            `Angels and VCs:
			Find your startup’s best-fit VCs, CVCs, Angel groups and Fund for your business.`,
            `Accelerators & Incubators:
			Find your startup's best-fit Accelerator/ Incubator program and Grow your business.`,
            `Tenders & Grants`,
        ],
    ...
    Legalify: {
        name: "Legalify Co.",
        logo: "/assets/logos/logo Legalify.svg",
        description:
            "LEGALIFY is a Legal-tech digital platform backed by Kemtix Technologies Venture Studio, LEGALIFY is powered by Badr & Associates law office. LEGALIFY emerged with a mission to make the legal services market more transparent, cost-effective, and accessible to all.			",
        services: [
            `WHY STARTUPS CHOOSE LEGALIFY`,

            `Legal Updates
			We keep our clients informed about the latest laws & regulations through regular newsletters and webinars.`,

            `Client-Centered
			At LEGALIFY, we prioritize our clients' needs, building long-term relationships & supporting their businesses throughout their growth journey.
			`,

            `Easy Process
			Our team of experienced lawyers simplifies the legal procedures, making it easy for our clients to navigate complex legal matters with confidence.
			`,

            `Excellent Reputation
			Our firm has earned a high reputation for delivering top-quality legal services that meet the unique needs of startups & entrepreneurs.
			`,

            `Affordable Packages
			We offer specially designed packages at affordable rates that cater to the needs of businesses in Egypt and the MENA region.
			`,

            `No Surprises or Hidden Fees
			Our transparent pricing model means that there are no hidden fees or surprises. Our fixed rates cover everything your business needs.`,
        ],
        img: "/assets/pics/legalify.jpg",
        category: "partners",
    },
    Kemtech: {
        name: "Kemtech",
