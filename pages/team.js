...
const NumberCounter = ({ value, label, max,labelNo }) => {
  ...
  return (
    <div className="w-1/2">
      <p className="text-4xl font-extrabold text-red-basic">{count}{labelNo}</p>
  ...
  return (
    <div className="container pt-10">
      ...
      <p>
        ...
        group of seasoned professionals who strive to
      ...
      <div className=" mt-5 flex flex-col gap-5">
        <div className="flex flex-col items-center gap-7 md:flex-row">
          <NumberCounter value={50} label="Accumulative years of experience+" max={50}labelNo={"+"} />      

          <NumberCounter value={250} label="Deals & Mandates worked on since 2007" max={250}labelNo={"+"} />
        </div>

        <div className="flex flex-col items-center gap-7 md:flex-row">
          <NumberCounter value={150} label="USD was raised in transactions closed" max={150}labelNo={"+ M"} />
          <NumberCounter value={250} label="Countries where our mandates and portfolio are located" max={10} />
        </div>
      </div>
