...
export default function Team() {
    return (
        <div className="container pt-10">
            ...
            <p>
                PTS Investment Holdings was established by a group of Investors,
                Private equity Telco&apos;s, Startups, & financial institutions.
            </p>
            <br />
            <p>
                At PTS Investment Holdings, our success is driven by the
                expertise and dedication of our management team. With a diverse
                group of seasoned professionals who strive to provide
                unparalleled financial services and investment solutions to our
                valued clients.
            </p>
