...
/>
<h1 className="md:header3 body-medium-bold text-center text-navy-basic" style={{ margin: "0 auto" }}>
...
<div className="left-element" style={{ fontSize: "20px" }}>
<li>
{" "}
<p style={{ display: "inline" }}>
EG: 7 st. Port Said Engineering Works Co, El Nozha, Cairo, EGY
</p>
</li>
<br />
<li>
...
{" "}
<p style={{ display: "inline" }}>
US: 16192 Coastal Highway Lew as Delaware, USA
</p>
</li>
<br />
<li>
{" "}
<p style={{ display: "inline" }}>
UK: 71-75 Shelton St, Covent Garden, WC2H 9JQ, Greater London, UK
</p>
</li>
</div>
</div>
</div>
<div className="w-full md:w-1/2 lg:w-1/2 mt-6 md:mt-0 lg:mt-0">
<div className="right-element" style={{ marginLeft: "auto", marginTop: "50px" }}>
<Image
