  ...
  return (
    <section className="container flex flex-col-reverse items-center gap-5 py-8 lg:flex-row lg:items-start lg:justify-between">
      ...
      <div className="space-y-4 text-center lg:w-1/2 lg:text-left">
        ...
        >
          We monitor the performance of the portfolio on a regular basis and
          adjust investments as needed in order to maintain desired profile. We
          regularly review our portfolio KPI performance against predetermined
          benchmarks in order to measure success and make adjustments as needed
          and utilize financial planning tools to manage cash flow needs and
